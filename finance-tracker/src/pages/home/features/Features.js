...
const Features = ({featuresScroll}) => {
    const features = [
        ...
        },
        {
            ...
            description: "Easily access and monitor your expenditures within each category, enabling you to get a clear view of areas where you are spending your money."
        },
        {
            ...
            description: "Elevate your financial awareness with our summary view which provides insights based on your daily, weekly, monthly, or yearly transaction history."
        }
    ];
